       ...
       <section className=' px-4 py-8 sm:px-6 lg:px-10'>
         <div className='mx-auto gap-4 flex max-w-7xl flex-col  items-center overflow-hidden rounded-2xl border border-gray-200 bg-blue-200 px-6 py-10 sm:px-10 lg:flex-row lg:px-12 lg:py-10'>
            <div className='w-full lg:w-1/2'>
                <p className='uppercase text-red-700 font-bold text-sm mb-4'>Workout Library</p>
                ...
                <button className='mt-12 rounded-md bg-red-700 px-5 py-3 text-xs font-bold uppercase text-white transition hover:bg-red-900'>Browser Workouts</button>
            </div>
