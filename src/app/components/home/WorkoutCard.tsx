    ...
    return (
        ...
        <div className="card w-full bg-white border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden">
            ...
            <div className="p-5 sm:p-5">
                ...
                <div className="flex flex-wrap gap-2"> {workout.muscleGroups.map((muscle) => (<span key={muscle} className="text-xs font-medium bg-red-50 text-red-600 px-3 py-1 rounded-full" >
                    {muscle} </span>))} </div>
